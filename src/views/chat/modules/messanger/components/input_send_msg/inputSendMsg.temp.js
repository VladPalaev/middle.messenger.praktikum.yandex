export const inputSendMsgTemp = `
<div class="chat-input__container">
	<button class="chat-input__attach btn" type="button">
	...
	<input class="chat-input__field" type="text" name="message" placeholder="Сообщение">

	<button class="chat-input__send-message btn" type="button">
